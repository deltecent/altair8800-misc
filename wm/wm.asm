...
l0146h:
	db CR
l0147h:
	db 'MicroPro WORDMASTER release 5.55A serial # KF2222KF   ',CR,LF,0
CLRSCRN:
	mvi a,ESC		;0180	3e 1b 	> . 
	call OUTCHAR		;0182	cd ef 01 	. . . 
	mvi a,'['		;0185	3e 5b 	> [ 
	call OUTCHAR		;0187	cd ef 01 	. . . 
	mvi a,'2'		;018a	3e 32 	> 2 
	call OUTCHAR		;018c	cd ef 01 	. . . 
	mvi a,'J'		;018f	3e 4a 	> J 
	jmp l01c0h		;0191	c3 c0 01 	. . . 
...
s0196h:
	...
	mov a,l			;01a0	7d 	} 
	inr a			;01a1	3c 	< 
	call 029b8h		;01a2	cd b8 29 	. . ) 
	mvi a,';'		;01a5	3e 3b 	> ; 
	call OUTCHAR		;01a7	cd ef 01 	. . . 
	mov a,h			;01aa	7c 	| 
	inr a			;01ab	3c 	< 
	call 029b8h		;01ac	cd b8 29 	. . ) 
	mvi a,'H'		;01af	3e 48 	> H 
	jmp OUTCHAR		;01b1	c3 ef 01 	. . . 
	db 0			;01b4	00 	. 
	db 0			;01b5	00 	. 
	db 001h,0d5h,029h	;01b6	01 d5 29 	. . ) 
l01b9h:
	db 018h,050h		;01b9	18 50 	. P 
l01bbh:
	db ESC			;01bb	1b 	. 
	db '['			;01bc	5b 	[ 
l01bdh:
...
l01beh:
	...
	db 000h			;01bf	00 	. 
l01c0h:
	call OUTCHAR		;01c0	cd ef 01 	. . . 
	mvi a,ESC		;01c3	3e 1b 	> . 
	call OUTCHAR		;01c5	cd ef 01 	. . . 
	mvi a,'['		;01c8	3e 5b 	> [ 
	call OUTCHAR		;01ca	cd ef 01 	. . . 
	mvi a,'1'		;01cd	3e 31 	> 1 
	call OUTCHAR		;01cf	cd ef 01 	. . . 
	mvi a,';'		;01d2	3e 3b 	> ; 
	call OUTCHAR		;01d4	cd ef 01 	. . . 
	mvi a,'1'		;01d7	3e 31 	> 1 
	call OUTCHAR		;01d9	cd ef 01 	. . . 
	mvi a,'H'		;01dc	3e 48 	> H 
	jmp OUTCHAR		;01de	c3 ef 01 	. . . 
	nop			;01e1	00 	. 
	nop			;01e2	00 	. 
	nop			;01e3	00 	. 
	nop			;01e4	00 	. 
	...
	nop			;01ea	00 	. 
	nop			;01eb	00 	. 
	jmp l024fh		;01ec	c3 4f 02 	. O . 
OUTCHAR:
	jmp l2592h		;01ef	c3 92 25 	. . % 
s01f2h:
	lxi h,00000h		;01f2	21 00 00 	. . . 
	shld l2683h		;01f5	22 83 26 	" . & 
	push b			;01f8	c5 	. 
	push d			;01f9	d5 	. 
	push h			;01fa	e5 	. 
	call CLRSCRN		;01fb	cd 80 01 	. . . 
	lda l01c0h+1		;01fe	3a c1 01 	: . . 
	call l024fh		;0201	cd 4f 02 	. O . 
	pop h			;0204	e1 	. 
	pop d			;0205	d1 	. 
	pop b			;0206	c1 	. 
	ret			;0207	c9 	. 
...
l020bh:
	...
	push d			;020f	d5 	. 
	xchg			;0210	eb 	. 
	lhld l2683h		;0211	2a 83 26 	* . & 
	call s1f9fh		;0214	cd 9f 1f 	. . . 
	xchg			;0217	eb 	. 
	pop d			;0218	d1 	. 
	rz			;0219	c8 	. 
	shld l2683h		;021a	22 83 26 	" . & 
	push b			;021d	c5 	. 
	push d			;021e	d5 	. 
	push h			;021f	e5 	. 
	call s0196h		;0220	cd 96 01 	. . . 
	lda l01c0h+2		;0223	3a c2 01 	: . . 
	call l024fh		;0226	cd 4f 02 	. O . 
	pop h			;0229	e1 	. 
	pop d			;022a	d1 	. 
	pop b			;022b	c1 	. 
...
s0239h:
	push psw			;0239	f5 	. 
	mvi a,ESC		;023a	3e 1b 	> . 
	call OUTCHAR		;023c	cd ef 01 	. . . 
	mvi a,'['		;023f	3e 5b 	> [ 
	call OUTCHAR		;0241	cd ef 01 	. . . 
	mvi a,'K'		;0244	3e 4b 	> K 
	call OUTCHAR		;0246	cd ef 01 	. . . 
	pop psw			;0249	f1 	. 
	nop			;024a	00 	. 
	nop			;024b	00 	. 
	nop			;024c	00 	. 
...
l0258h:
	dcr a			;0258	3d 	= 
	jnz l0258h		;0259	c2 58 02 	. X . 
	pop psw			;025c	f1 	. 
	jmp l0250h		;025d	c3 50 02 	. P . 
l0260h:
...
ENTRY:
	...
	db 0			;0273	00 	. 
INIT:
	sta l274ah+2		;0274	32 4c 27 	2 L ' 
	lxi h,00000h		;0277	21 00 00 	. . . 
	dad sp			;027a	39 	9 
	shld l275fh+1		;027b	22 60 27 	" ` ' 
	lxi d,l0146h		;027e	11 46 01 	. F . 
	call s230eh		;0281	cd 0e 23 	. . # 
	lxi d,l0106h		;0284	11 06 01 	. . . 
	call s230eh		;0287	cd 0e 23 	. . # 
	lhld 00001h		;028a	2a 01 00 	* . . 
...
l02afh:
	...
	cpi 0afh		;02b1	fe af 	. . 
	sta l274ah+1		;02b3	32 4b 27 	2 K ' 
	lda l01bdh		;02b6	3a bd 01 	: . . 
	ora a			;02b9	b7 	. 
...
l02d7h:
	...
	lhld 001b7h		;02da	2a b7 01 	* . . 
	xchg			;02dd	eb 	. 
	lxi h,l2730h+1		;02de	21 31 27 	. 1 ' 
...
l02e3h:
	...
	inx d			;02ed	13 	. 
	xchg			;02ee	eb 	. 
	shld l2739h		;02ef	22 39 27 	" 9 ' 
l02f2h:
	lhld l2739h		;02f2	2a 39 27 	* 9 ' 
	shld l273bh		;02f5	22 3b 27 	" ; ' 
	shld 0273dh		;02f8	22 3d 27 	" = ' 
	shld 0273fh		;02fb	22 3f 27 	" ? ' 
	shld l2741h		;02fe	22 41 27 	" A ' 
...
l0345h:
	...
	ani 03ch		;034c	e6 3c 	. < 
	mov b,a			;034e	47 	G 
	sta l272bh		;034f	32 2b 27 	2 + ' 
	rlc			;0352	07 	. 
	sta l272dh+1		;0353	32 2e 27 	2 . ' 
	mov a,b			;0356	78 	x 
	cpi 008h		;0357	fe 08 	. . 
	jnc l035eh		;0359	d2 5e 03 	. ^ . 
	mvi a,008h		;035c	3e 08 	> . 
l035eh:
	sta l2730h		;035e	32 30 27 	2 0 ' 
	mov a,h			;0361	7c 	| 
	...
	dad h			;036d	29 	) 
l036eh:
	shld l2728h		;036e	22 28 27 	" ( ' 
	mvi a,008h		;0371	3e 08 	> . 
	sta l272ch		;0373	32 2c 27 	2 , ' 
	jc l037ah		;0376	da 7a 03 	. z . 
	add a			;0379	87 	. 
l037ah:
	sta l272dh		;037a	32 2d 27 	2 - ' 
...
l0397h:
	...
	mov m,a			;039b	77 	w 
	lxi d,l26aah+1		;039c	11 ab 26 	. . & 
	push d			;039f	d5 	. 
	lxi b,00010h		;03a0	01 10 00 	. . . 
	call s1f0ch		;03a3	cd 0c 1f 	. . . 
	mov a,m			;03a6	7e 	~ 
	pop h			;03a7	e1 	. 
	ora a			;03a8	b7 	. 
...
l040eh:
	sta l271dh		;040e	32 1d 27 	2 . ' 
	call s2306h		;0411	cd 06 23 	. . # 
	db LF,'NEW FILE',CR,LF,LF,0
l0421h:
	lxi d,l26b4h		;0421	11 b4 26 	. . & 
	push d			;0424	d5 	. 
	call s1f06h		;0425	cd 06 1f 	. . . 
	lxi d,l26aah+1		;0428	11 ab 26 	. . & 
...
l0519h:
	...
	rz			;051c	c8 	. 
l051dh:
	call s2306h		;051d	cd 06 23 	. . # 
	dcr c			;0520	0d 	. 
	ldax b			;0521	0a 	. 
	db ' ???',0
l0527h:
	lhld l274dh		;0527	2a 4d 27 	* M ' 
	xchg			;052a	eb 	. 
	call s230eh		;052b	cd 0e 23 	. . # 
...
l0588h:
	...
	push h			;05b6	e5 	. 
	lhld l2758h		;05b7	2a 58 27 	* X ' 
	xchg			;05ba	eb 	. 
	lxi h,00002h		;05bb	21 02 00 	. . . 
	call s1f9fh		;05be	cd 9f 1f 	. . . 
	pop h			;05c1	e1 	. 
...
l0627h:
	pop h			;0627	e1 	. 
	ora a			;0628	b7 	. 
	jmp l1fcch		;0629	c3 cc 1f 	. . . 
l062ch:
	lda l274ah+2		;062c	3a 4c 27 	: L ' 
	ora a			;062f	b7 	. 
	jz l0627h		;0630	ca 27 06 	. ' . 
	jmp 00038h		;0633	c3 38 00 	. 8 . 
l0636h:
	dcx sp			;0636	3b 	; 
	dcx sp			;0637	3b 	; 
...
l06f8h:
	...
	pop h			;0709	e1 	. 
	shld l274fh		;070a	22 4f 27 	" O ' 
	ret			;070d	c9 	. 
l070eh:
	call s2306h		;070e	cd 06 23 	. . # 
	dw 05120h		;0711	20 51 	  Q 
	mov e,b			;0713	58 	X 
	cmc			;0714	3f 	? 
	nop			;0715	00 	. 
...
l0747h:
	lda l275ah+2		;0747	3a 5c 27 	: \ ' 
	cma			;074a	2f 	/ 
s074bh:
	lxi h,0ffffh		;074b	21 ff ff 	. . . 
l074eh:
	sta l275ah+2		;074e	32 5c 27 	2 \ ' 
s0751h:
	shld l2758h		;0751	22 58 27 	" X ' 
l0754h:
	...
	ret			;0760	c9 	. 
s0761h:
	lxi d,00001h		;0761	11 01 00 	. . . 
l0764h:
	lhld l2758h		;0764	2a 58 27 	* X ' 
	push h			;0767	e5 	. 
	xchg			;0768	eb 	. 
	call s0751h		;0769	cd 51 07 	. Q . 
	pop h			;076c	e1 	. 
	shld l2758h		;076d	22 58 27 	" X ' 
	ret			;0770	c9 	. 
s0771h:
...
s0781h:
	xra a			;0781	af 	. 
s0782h:
	sta l275ah+2		;0782	32 5c 27 	2 \ ' 
	xra a			;0785	af 	. 
	sta l271eh		;0786	32 1e 27 	2 . ' 
	shld l2758h		;0789	22 58 27 	" X ' 
	ret			;078c	c9 	. 
l078dh:
...
l07cdh:
	lhld l2758h		;07cd	2a 58 27 	* X ' 
	push h			;07d0	e5 	. 
	lhld l275ah+2		;07d1	2a 5c 27 	* \ ' 
	push h			;07d4	e5 	. 
	call s0828h		;07d5	cd 28 08 	. ( . 
	lhld l01b9h		;07d8	2a b9 01 	* . . 
	...
	pop h			;07e6	e1 	. 
	shld l275ah+2		;07e7	22 5c 27 	" \ ' 
	pop h			;07ea	e1 	. 
	shld l2758h		;07eb	22 58 27 	" X ' 
	call s081ah		;07ee	cd 1a 08 	. . . 
	call s1cb5h		;07f1	cd b5 1c 	. . . 
	rnz			;07f4	c0 	. 
	lda l275ah+2		;07f5	3a 5c 27 	: \ ' 
	ora a			;07f8	b7 	. 
	lxi h,0273fh		;07f9	21 3f 27 	. ? ' 
	jp l0802h		;07fc	f2 02 08 	. . . 
	lxi h,l273bh		;07ff	21 3b 27 	. ; ' 
l0802h:
...
s081ah:
	push h			;081a	e5 	. 
	lhld l2758h		;081b	2a 58 27 	* X ' 
	mov a,h			;081e	7c 	| 
	ora l			;081f	b5 	. 
	jz l0824h		;0820	ca 24 08 	. $ . 
	dcx h			;0823	2b 	+ 
l0824h:
	shld l2758h		;0824	22 58 27 	" X ' 
	pop h			;0827	e1 	. 
s0828h:
	push h			;0828	e5 	. 
	lhld l2758h		;0829	2a 58 27 	* X ' 
	lda l271eh		;082c	3a 1e 27 	: . ' 
	ora h			;082f	b4 	. 
	ora l			;0830	b5 	. 
	pop h			;0831	e1 	. 
...
l08d7h:
	...
	lda l2762h		;08e5	3a 62 27 	: b ' 
	ora a			;08e8	b7 	. 
	lxi d,l0143h		;08e9	11 43 01 	. C . 
	mvi a,002h		;08ec	3e 02 	> . 
	cz s0c23h		;08ee	cc 23 0c 	. # . 
	jmp s081ah		;08f1	c3 1a 08 	. . . 
l08f4h:
	lda l2758h		;08f4	3a 58 27 	: X ' 
	push psw			;08f7	f5 	. 
...
s091ah:
	push h			;091a	e5 	. 
	lhld l274fh		;091b	2a 4f 27 	* O ' 
l091eh:
	push b			;091e	c5 	. 
	push psw			;091f	f5 	. 
	lxi d,l2762h+1		;0920	11 63 27 	. c ' 
	push d			;0923	d5 	. 
...
l0945h:
	...
	sta l2762h		;094b	32 62 27 	2 b ' 
	shld l274fh		;094e	22 4f 27 	" O ' 
	xra a			;0951	af 	. 
	stax d			;0952	12 	. 
	pop d			;0953	d1 	. 
	mov a,c			;0954	79 	y 
...
l096dh:
	...
	pop d			;0973	d1 	. 
	push d			;0974	d5 	. 
	lhld l274fh		;0975	2a 4f 27 	* O ' 
	call s22f1h		;0978	cd f1 22 	. . " 
	lda l274ah+1		;097b	3a 4b 27 	: K ' 
	ora a			;097e	b7 	. 
	jnz l099ah		;097f	c2 9a 09 	. . . 
	push d			;0982	d5 	. 
	shld l274fh		;0983	22 4f 27 	" O ' 
	lxi b,0019fh		;0986	01 9f 01 	. . . 
	lxi d,l274fh		;0989	11 4f 27 	. O ' 
	call BDOS		;098c	cd 05 00 	. . . 
	lhld l274fh		;098f	2a 4f 27 	* O ' 
	pop d			;0992	d1 	. 
...
l09ach:
	...
	shld l274fh		;09d2	22 4f 27 	" O ' 
	call s095eh		;09d5	cd 5e 09 	. ^ . 
	jz l1fcch		;09d8	ca cc 1f 	. . . 
l09dbh:
...
l0a2eh:
	...
	lxi h,l2733h+2		;0a34	21 35 27 	. 5 ' 
	jmp l0c1eh		;0a37	c3 1e 0c 	. . . 
l0a3ah:
	lxi h,l2733h		;0a3a	21 33 27 	. 3 ' 
...
s0a43h:
	...
	rnz			;0a46	c0 	. 
l0a47h:
	lhld l2733h		;0a47	2a 33 27 	* 3 ' 
	shld l2733h+2		;0a4a	22 35 27 	" 5 ' 
	ret			;0a4d	c9 	. 
l0a4eh:
	lxi h,l2733h		;0a4e	21 33 27 	. 3 ' 
...
l0a5eh:
	lxi h,l2733h+2		;0a5e	21 35 27 	. 5 ' 
	...
	lxi h,l2733h+2		;0a6f	21 35 27 	. 5 ' 
...
s0aa1h:
	...
	push d			;0aa2	d5 	. 
	push h			;0aa3	e5 	. 
	lxi h,l2733h		;0aa4	21 33 27 	. 3 ' 
	call s1efbh		;0aa7	cd fb 1e 	. . . 
	lhld l2730h+1		;0aaa	2a 31 27 	* 1 ' 
	xchg			;0aad	eb 	. 
	lhld l2743h		;0aae	2a 43 27 	* C ' 
	call s1f7ch		;0ab1	cd 7c 1f 	. | . 
	call s1f71h		;0ab4	cd 71 1f 	. q . 
	dad b			;0ab7	09 	. 
	lxi d,00d80h		;0ab8	11 80 0d 	. . . 
	call s1f9fh		;0abb	cd 9f 1f 	. . . 
	jc l1fcch		;0abe	da cc 1f 	. . . 
...
s0bebh:
	xchg			;0beb	eb 	. 
	lhld l273bh		;0bec	2a 3b 27 	* ; ' 
	call s1f9fh		;0bef	cd 9f 1f 	. . . 
	xchg			;0bf2	eb 	. 
	rnc 			;0bf3	d0 	. 
	xchg			;0bf4	eb 	. 
...
l0c1eh:
	lxi d,l2762h+1		;0c1e	11 63 27 	. c ' 
	ldax d			;0c21	1a 	. 
	inx d			;0c22	13 	. 
s0c23h:
	mov c,a			;0c23	4f 	O 
...
s0cf3h:
	...
	lda l2762h+1		;0cf6	3a 63 27 	: c ' 
	call s091ah		;0cf9	cd 1a 09 	. . . 
	rc			;0cfc	d8 	. 
	mov b,a			;0cfd	47 	G 
	lda l275ah+2		;0cfe	3a 5c 27 	: \ ' 
	ora a			;0d01	b7 	. 
	mov a,b			;0d02	78 	x 
...
s0da0h:
	...
	lhld l2758h		;0da5	2a 58 27 	* X ' 
	xchg			;0da8	eb 	. 
	lda l275ah+2		;0da9	3a 5c 27 	: \ ' 
	ora a			;0dac	b7 	. 
...
l0dfeh:
	pop psw			;0dfe	f1 	. 
	xchg			;0dff	eb 	. 
	shld l2758h		;0e00	22 58 27 	" X ' 
	pop d			;0e03	d1 	. 
s0e04h:
	push b			;0e04	c5 	. 
	push d			;0e05	d5 	. 
	lhld l2758h		;0e06	2a 58 27 	* X ' 
	xchg			;0e09	eb 	. 
	lxi h,l275ah+2		;0e0a	21 5c 27 	. \ ' 
	mov a,d			;0e0d	7a 	z 
	ora e			;0e0e	b3 	. 
...
l0e4ch:
	xra a			;0e4c	af 	. 
l0e4dh:
	sta l271eh		;0e4d	32 1e 27 	2 . ' 
	call s1cb5h		;0e50	cd b5 1c 	. . . 
	jnz l0e5ch		;0e53	c2 5c 0e 	. \ . 
	lxi h,00000h		;0e56	21 00 00 	. . . 
	shld l271eh		;0e59	22 1e 27 	" . ' 
l0e5ch:
	shld l2758h		;0e5c	22 58 27 	" X ' 
	xchg			;0e5f	eb 	. 
	shld 02756h		;0e60	22 56 27 	" V ' 
	lda l275ah+2		;0e63	3a 5c 27 	: \ ' 
	ora a			;0e66	b7 	. 
	push h			;0e67	e5 	. 
	lxi h,0ffffh		;0e68	21 ff ff 	. . . 
	dad d			;0e6b	19 	. 
	jc l1fcch		;0e6c	da cc 1f 	. . . 
	lhld l271dh		;0e6f	2a 1d 27 	* . ' 
	dad h			;0e72	29 	) 
	jmp l1fcch		;0e73	c3 cc 1f 	. . . 
l0e76h:
	dcx d			;0e76	1b 	. 
	xchg			;0e77	eb 	. 
...
l0ee5h:
	...
	push h			;0ee7	e5 	. 
	xchg			;0ee8	eb 	. 
	lhld l273bh		;0ee9	2a 3b 27 	* ; ' 
	call s1f9fh		;0eec	cd 9f 1f 	. . . 
	cc s0f1dh		;0eef	dc 1d 0f 	. . . 
	lhld l2741h		;0ef2	2a 41 27 	* A ' 
	inx h			;0ef5	23 	# 
	call s1f9fh		;0ef6	cd 9f 1f 	. . . 
	cnc s0f1dh		;0ef9	d4 1d 0f 	. . . 
	lhld 0273dh		;0efc	2a 3d 27 	* = ' 
	inx h			;0eff	23 	# 
	call s1f9fh		;0f00	cd 9f 1f 	. . . 
	jnc l0f0dh		;0f03	d2 0d 0f 	. . . 
	xchg			;0f06	eb 	. 
	lxi d,l273bh		;0f07	11 3b 27 	. ; ' 
	jmp l1e28h		;0f0a	c3 28 1e 	. ( . 
l0f0dh:
	lhld 0273fh		;0f0d	2a 3f 27 	* ? ' 
	call s1f9fh		;0f10	cd 9f 1f 	. . . 
...
l1006h:
	lhld l2683h		;1006	2a 83 26 	* . & 
	push h			;1009	e5 	. 
l100ah:
	call s241fh		;100a	cd 1f 24 	. . $ 
	lda l2683h		;100d	3a 83 26 	: . & 
...
l127ch:
	...
	lhld l2683h		;1293	2a 83 26 	* . & 
	push h			;1296	e5 	. 
	lxi h,00000h		;1297	21 00 00 	. . . 
	shld l2683h		;129a	22 83 26 	" . & 
	call s1816h		;129d	cd 16 18 	. . . 
	lhld 02756h		;12a0	2a 56 27 	* V ' 
	call l0ee5h		;12a3	cd e5 0e 	. . . 
	lda l2683h		;12a6	3a 83 26 	: . & 
	jmp l132eh		;12a9	c3 2e 13 	. . . 
l12ach:
	mvi d,000h		;12ac	16 00 	. . 
	mvi a,0f0h		;12ae	3e f0 	> . 
l12b0h:
	sta l268fh+1		;12b0	32 90 26 	2 . & 
	jmp l12f7h		;12b3	c3 f7 12 	. . . 
	mvi d,000h		;12b6	16 00 	. . 
...
s1728h:
	...
	inr h			;1764	24 	$ 
	shld l2745h		;1765	22 45 27 	" E ' 
	call s178ch		;1768	cd 8c 17 	. . . 
	xchg			;176b	eb 	. 
	lhld l2683h		;176c	2a 83 26 	* . & 
...
l1785h:
	pop h			;1785	e1 	. 
	shld l2683h		;1786	22 83 26 	" . & 
	jmp l1fcch		;1789	c3 cc 1f 	. . . 
s178ch:
...
s179eh:
	...
	push h			;17b2	e5 	. 
	lxi h,l2683h+1		;17b3	21 84 26 	. . & 
	inr m			;17b6	34 	4 
	lda l01b9h+1		;17b7	3a ba 01 	: . . 
	dcr a			;17ba	3d 	= 
	cmp m			;17bb	be 	. 
	pop h			;17bc	e1 	. 
...
s1801h:
	dcr a			;1801	3d 	= 
	sta l2683h		;1802	32 83 26 	2 . & 
	ora a			;1805	b7 	. 
	rm			;1806	f8 	. 
s1807h:
	lda l2683h		;1807	3a 83 26 	: . & 
	inr a			;180a	3c 	< 
	inr a			;180b	3c 	< 
	mov d,a			;180c	57 	W 
...
l1832h:
	...
	push h			;183f	e5 	. 
	lxi h,l2683h+1		;1840	21 84 26 	. . & 
	inr m			;1843	34 	4 
	lda l01b9h+1		;1844	3a ba 01 	: . . 
	dcr a			;1847	3d 	= 
	cmp m			;1848	be 	. 
	pop h			;1849	e1 	. 
...
s1856h:
	...
	lhld l2683h		;1859	2a 83 26 	* . & 
	rc			;185c	d8 	. 
s185dh:
	call s246ch		;185d	cd 6c 24 	. l $ 
	rnc 			;1860	d0 	. 
	push h			;1861	e5 	. 
	lhld l2683h		;1862	2a 83 26 	* . & 
	inr l			;1865	2c 	, 
...
s18beh:
	...
	push h			;18c0	e5 	. 
l18c1h:
	lda l2749h		;18c1	3a 49 27 	: I ' 
	ora a			;18c4	b7 	. 
	jnz l18ddh		;18c5	c2 dd 18 	. . . 
	call s18e3h		;18c8	cd e3 18 	. . . 
	jc l1fcch		;18cb	da cc 1f 	. . . 
...
l18ddh:
	...
	jmp l1fcch		;18e0	c3 cc 1f 	. . . 
s18e3h:
	lda l2749h		;18e3	3a 49 27 	: I ' 
	ora a			;18e6	b7 	. 
	rnz			;18e7	c0 	. 
	lda 0f7ffh		;18e8	3a ff f7 	: . . 
	lxi h,l274ah		;18eb	21 4a 27 	. J ' 
	cmp m			;18ee	be 	. 
	rz			;18ef	c8 	. 
	lda l2749h		;18f0	3a 49 27 	: I ' 
	ora a			;18f3	b7 	. 
	rnz			;18f4	c0 	. 
...
l191fh:
	sta l01b9h		;191f	32 b9 01 	2 . . 
	sui 002h		;1922	d6 02 	. . 
	sta l2680h		;1924	32 80 26 	2 . & 
	mvi a,015h		;1927	3e 15 	> . 
	sta l01bbh		;1929	32 bb 01 	2 . . 
	pop psw			;192c	f1 	. 
	sta l274ah		;192d	32 4a 27 	2 J ' 
	stc			;1930	37 	7 
	ret			;1931	c9 	. 
l1932h:
	db 0,'WM      ','HLP'
...
l1957h:
	...
	lxi h,l27e9h		;19b1	21 e9 27 	. . ' 
	call s1c8fh		;19b4	cd 8f 1c 	. . . 
	lxi h,l27e9h		;19b7	21 e9 27 	. . ' 
l19bah:
	push psw			;19ba	f5 	. 
	mov a,m			;19bb	7e 	~ 
	inx h			;19bc	23 	# 
...
s1a91h:
	...
	lda l275ah+2		;1a94	3a 5c 27 	: \ ' 
	ora a			;1a97	b7 	. 
	jm s1cc1h		;1a98	fa c1 1c 	. . . 
	jmp s1c4dh		;1a9b	c3 4d 1c 	. M . 
s1a9eh:
	lda l275ah+2		;1a9e	3a 5c 27 	: \ ' 
	ora a			;1aa1	b7 	. 
	stc			;1aa2	37 	7 
...
s1abeh:
	...
	push d			;1abf	d5 	. 
	push h			;1ac0	e5 	. 
	lda l275ah+2		;1ac1	3a 5c 27 	: \ ' 
	ora a			;1ac4	b7 	. 
	lxi d,l273bh		;1ac5	11 3b 27 	. ; ' 
	jm l1aceh		;1ac8	fa ce 1a 	. . . 
	lxi d,0273fh		;1acb	11 3f 27 	. ? ' 
l1aceh:
	lhld l272dh+2		;1ace	2a 2f 27 	* / ' 
	xchg			;1ad1	eb 	. 
	call s1efbh		;1ad2	cd fb 1e 	. . . 
	mov h,b			;1ad5	60 	` 
	mov l,c			;1ad6	69 	i 
	call s1f9fh		;1ad7	cd 9f 1f 	. . . 
	jmp l1fcch		;1ada	c3 cc 1f 	. . . 
s1addh:
	push b			;1add	c5 	. 
	push d			;1ade	d5 	. 
	push h			;1adf	e5 	. 
	call s1b0ch		;1ae0	cd 0c 1b 	. . . 
	jc l1fcch		;1ae3	da cc 1f 	. . . 
	lxi h,l275fh		;1ae6	21 5f 27 	. _ ' 
	inr m			;1ae9	34 	4 
	mov b,m			;1aea	46 	F 
	lxi h,l272dh+1		;1aeb	21 2e 27 	. . ' 
	xra a			;1aee	af 	. 
l1aefh:
	add m			;1aef	86 	. 
	dcr b			;1af0	05 	. 
...
l1b08h:
	ora a			;1b08	b7 	. 
	jmp l1fcch		;1b09	c3 cc 1f 	. . . 
s1b0ch:
	lhld l273bh		;1b0c	2a 3b 27 	* ; ' 
	call s1d73h		;1b0f	cd 73 1d 	. s . 
	rc			;1b12	d8 	. 
	push h			;1b13	e5 	. 
	lhld l26cdh		;1b14	2a cd 26 	* . & 
	xchg			;1b17	eb 	. 
	lhld l271eh+2		;1b18	2a 20 27 	*   ' 
	call s1f9fh		;1b1b	cd 9f 1f 	. . . 
	pop h			;1b1e	e1 	. 
	lxi d,l26aah+1		;1b1f	11 ab 26 	. . & 
...
l1b2bh:
	...
	xchg			;1b2e	eb 	. 
	lhld l271eh+2		;1b2f	2a 20 27 	*   ' 
	inx h			;1b32	23 	# 
	shld l271eh+2		;1b33	22 20 27 	"   ' 
	xchg			;1b36	eb 	. 
	inr b			;1b37	04 	. 
l1b38h:
	lxi d,DBUFF		;1b38	11 80 00 	. . . 
	dad d			;1b3b	19 	. 
	shld l273bh		;1b3c	22 3b 27 	" ; ' 
	ret			;1b3f	c9 	. 
s1b40h:
	push b			;1b40	c5 	. 
	push d			;1b41	d5 	. 
	...
	shld l2745h		;1b46	22 45 27 	" E ' 
	lxi h,l2743h		;1b49	21 43 27 	. C ' 
	call s1e49h		;1b4c	cd 49 1e 	. I . 
	lhld l2741h		;1b4f	2a 41 27 	* A ' 
	call l0ee5h		;1b52	cd e5 0e 	. . . 
l1b55h:
	call s1b0ch		;1b55	cd 0c 1b 	. . . 
	jnc l1b55h		;1b58	d2 55 1b 	. U . 
	jmp l1fcch		;1b5b	c3 cc 1f 	. . . 
s1b5eh:
	push b			;1b5e	c5 	. 
	push d			;1b5f	d5 	. 
	push h			;1b60	e5 	. 
	call s1b7eh		;1b61	cd 7e 1b 	. ~ . 
	jc l1fcch		;1b64	da cc 1f 	. . . 
	lda l272dh		;1b67	3a 2d 27 	: - ' 
	mov b,a			;1b6a	47 	G 
	dcr b			;1b6b	05 	. 
	add a			;1b6c	87 	. 
	mov c,a			;1b6d	4f 	O 
...
l1b7ah:
	ora a			;1b7a	b7 	. 
	jmp l1fcch		;1b7b	c3 cc 1f 	. . . 
s1b7eh:
	lhld l2741h		;1b7e	2a 41 27 	* A ' 
...
l1bbdh:
	push h			;1bbd	e5 	. 
	lhld l2724h		;1bbe	2a 24 27 	* $ ' 
	xchg			;1bc1	eb 	. 
	call s1de3h		;1bc2	cd e3 1d 	. . . 
	call s1f9fh		;1bc5	cd 9f 1f 	. . . 
	pop h			;1bc8	e1 	. 
	lxi d,l26d0h+1		;1bc9	11 d1 26 	. . & 
...
l1bd5h:
	...
	push h			;1bd8	e5 	. 
	lhld l2724h		;1bd9	2a 24 27 	* $ ' 
	dcx h			;1bdc	2b 	+ 
	shld l2724h		;1bdd	22 24 27 	" $ ' 
	pop h			;1be0	e1 	. 
	inr b			;1be1	04 	. 
l1be2h:
	...
	ora a			;1be5	b7 	. 
	pop h			;1be6	e1 	. 
	shld l2741h		;1be7	22 41 27 	" A ' 
	ret			;1bea	c9 	. 
s1bebh:
	push b			;1beb	c5 	. 
	push d			;1bec	d5 	. 
	lxi d,l27e9h		;1bed	11 e9 27 	. . ' 
	push d			;1bf0	d5 	. 
	mov b,a			;1bf1	47 	G 
...
s1c0bh:
	...
	call s1f9fh		;1c18	cd 9f 1f 	. . . 
	xchg			;1c1b	eb 	. 
	lhld l2728h		;1c1c	2a 28 27 	* ( ' 
...
s1c4dh:
	...
	lxi h,l2743h		;1c56	21 43 27 	. C ' 
	call s1cf3h		;1c59	cd f3 1c 	. . . 
l1c5ch:
	lhld l2741h		;1c5c	2a 41 27 	* A ' 
l1c5fh:
...
l1c6bh:
	shld l2741h		;1c6b	22 41 27 	" A ' 
	dcr c			;1c6e	0d 	. 
	jnz l1c5fh		;1c6f	c2 5f 1c 	. _ . 
	ora a			;1c72	b7 	. 
l1c73h:
	jmp l1fcch		;1c73	c3 cc 1f 	. . . 
s1c76h:
	call s23d6h		;1c76	cd d6 23 	. . # 
	lxi d,l26d0h		;1c79	11 d0 26 	. . & 
	ldax d			;1c7c	1a 	. 
	inx d			;1c7d	13 	. 
	ora a			;1c7e	b7 	. 
	stc			;1c7f	37 	7 
...
s1caah:
	...
	lxi h,l26d0h		;1cae	21 d0 26 	. . & 
	ora m			;1cb1	b6 	. 
	stc			;1cb2	37 	7 
	pop h			;1cb3	e1 	. 
	ret			;1cb4	c9 	. 
s1cb5h:
	lda l275ah+2		;1cb5	3a 5c 27 	: \ ' 
	ora a			;1cb8	b7 	. 
...
s1d83h:
	...
	dad d			;1d8b	19 	. 
	pop d			;1d8c	d1 	. 
	call s1f9fh		;1d8d	cd 9f 1f 	. . . 
	xchg			;1d90	eb 	. 
	ret			;1d91	c9 	. 
s1d92h:
	push d			;1d92	d5 	. 
	lxi d,0273dh		;1d93	11 3d 27 	. = ' 
	call s1f9fh		;1d96	cd 9f 1f 	. . . 
	pop d			;1d99	d1 	. 
	rnz			;1d9a	c0 	. 
s1d9bh:
	push b			;1d9b	c5 	. 
	...
	push h			;1d9d	e5 	. 
	push psw			;1d9e	f5 	. 
	lxi h,l273bh		;1d9f	21 3b 27 	. ; ' 
	call s1df4h		;1da2	cd f4 1d 	. . . 
	lhld l26cdh		;1da5	2a cd 26 	* . & 
	dad d			;1da8	19 	. 
	xchg			;1da9	eb 	. 
	lhld l271eh+2		;1daa	2a 20 27 	*   ' 
	call s1f9fh		;1dad	cd 9f 1f 	. . . 
	xchg			;1db0	eb 	. 
	jnc l1db7h		;1db1	d2 b7 1d 	. . . 
	shld l271eh+2		;1db4	22 20 27 	"   ' 
l1db7h:
	...
	call s1f9fh		;1dc7	cd 9f 1f 	. . . 
	xchg			;1dca	eb 	. 
	jc l1dd1h		;1dcb	da d1 1d 	. . . 
	shld 02722h		;1dce	22 22 27 	" " ' 
l1dd1h:
	xchg			;1dd1	eb 	. 
	lhld l2724h		;1dd2	2a 24 27 	* $ ' 
	call s1f9fh		;1dd5	cd 9f 1f 	. . . 
	xchg			;1dd8	eb 	. 
	jc l1ddfh		;1dd9	da df 1d 	. . . 
	shld l2724h		;1ddc	22 24 27 	" $ ' 
l1ddfh:
	pop psw			;1ddf	f1 	. 
	jmp l1fcch		;1de0	c3 cc 1f 	. . . 
s1de3h:
	push d			;1de3	d5 	. 
...
l1e4ch:
	xchg			;1e4c	eb 	. 
	lxi h,l2733h		;1e4d	21 33 27 	. 3 ' 
	call s1f9fh		;1e50	cd 9f 1f 	. . . 
	cc s1e86h		;1e53	dc 86 1e 	. . . 
	lxi h,l2744h		;1e56	21 44 27 	. D ' 
	call s1f9fh		;1e59	cd 9f 1f 	. . . 
	cnc s1e86h		;1e5c	d4 86 1e 	. . . 
	lxi h,l2733h		;1e5f	21 33 27 	. 3 ' 
l1e62h:
	inx h			;1e62	23 	# 
	call s1f9fh		;1e63	cd 9f 1f 	. . . 
	dcx h			;1e66	2b 	+ 
...
l1e73h:
	lxi h,l2741h		;1e73	21 41 27 	. A ' 
l1e76h:
	call s1f9fh		;1e76	cd 9f 1f 	. . . 
	jnc l1fcch		;1e79	d2 cc 1f 	. . . 
...
s1e95h:
	...
	lxi h,l2730h+1		;1e9a	21 31 27 	. 1 ' 
l1e9dh:
...
s1each:
	...
	inx h			;1eaf	23 	# 
	inx h			;1eb0	23 	# 
	lxi d,l2742h		;1eb1	11 42 27 	. B ' 
	call s1f9fh		;1eb4	cd 9f 1f 	. . . 
	pop d			;1eb7	d1 	. 
	ret			;1eb8	c9 	. 
s1eb9h:
	lxi h,s2736h+1		;1eb9	21 37 27 	. 7 ' 
s1ebch:
	push b			;1ebc	c5 	. 
	push d			;1ebd	d5 	. 
	push h			;1ebe	e5 	. 
...
s1f0ch:
	...
	call s1f9fh		;1f0f	cd 9f 1f 	. . . 
	jnz l1f1ch		;1f12	c2 1c 1f 	. . . 
	dad b			;1f15	09 	. 
	xchg			;1f16	eb 	. 
	dad b			;1f17	09 	. 
	lxi b,00000h		;1f18	01 00 00 	. . . 
	ret			;1f1b	c9 	. 
l1f1ch:
	inr b			;1f1c	04 	. 
	inr c			;1f1d	0c 	. 
	jmp l1f25h		;1f1e	c3 25 1f 	. % . 
l1f21h:
	mov a,m			;1f21	7e 	~ 
	stax d			;1f22	12 	. 
	inx h			;1f23	23 	# 
...
l1f25h:
	dcr c			;1f25	0d 	. 
	jnz l1f21h		;1f26	c2 21 1f 	. . . 
	dcr b			;1f29	05 	. 
	jnz l1f21h		;1f2a	c2 21 1f 	. . . 
	ret			;1f2d	c9 	. 
s1f2eh:
	call s1f56h		;1f2e	cd 56 1f 	. V . 
	call s1f9fh		;1f31	cd 9f 1f 	. . . 
...
s20cbh:
	...
	push psw			;20dc	f5 	. 
	push h			;20dd	e5 	. 
	lxi h,l26d0h+1		;20de	21 d1 26 	. . & 
	call s1f9fh		;20e1	cd 9f 1f 	. . . 
	pop h			;20e4	e1 	. 
	jz l20f7h		;20e5	ca f7 20 	. .   
l20e8h:
	lda l26d0h		;20e8	3a d0 26 	: . & 
	ora a			;20eb	b7 	. 
	push d			;20ec	d5 	. 
...
s211ah:
	...
	push h			;211b	e5 	. 
	push d			;211c	d5 	. 
	lxi b,DBUFF		;211d	01 80 00 	. . . 
	lxi d,l27e9h		;2120	11 e9 27 	. . ' 
	push d			;2123	d5 	. 
	call s1f0ch		;2124	cd 0c 1f 	. . . 
	pop h			;2127	e1 	. 
	pop d			;2128	d1 	. 
...
l2140h:
	...
	mov m,d			;2159	72 	r 
	ora a			;215a	b7 	. 
	jmp l1fcch		;215b	c3 cc 1f 	. . . 
l215eh:
	xra a			;215e	af 	. 
	stax d			;215f	12 	. 
	stc			;2160	37 	7 
	pop h			;2161	e1 	. 
	jmp l1fcch		;2162	c3 cc 1f 	. . . 
s2165h:
...
l220ah:
	xchg			;220a	eb 	. 
	shld l275ah		;220b	22 5a 27 	" Z ' 
	xchg			;220e	eb 	. 
l220fh:
	xchg			;220f	eb 	. 
	shld l2758h		;2210	22 58 27 	" X ' 
	xchg			;2213	eb 	. 
	ret			;2214	c9 	. 
l2215h:
...
s23c7h:
	...
	push d			;23c8	d5 	. 
	push h			;23c9	e5 	. 
	lxi h,l1fcch		;23ca	21 cc 1f 	. . . 
	push h			;23cd	e5 	. 
	lhld 00001h		;23ce	2a 01 00 	* . . 
	call s0d4ah		;23d1	cd 4a 0d 	. J . 
	mov a,c			;23d4	79 	y 
	pchl			;23d5	e9 	. 
s23d6h:
	push psw			;23d6	f5 	. 
...
l243fh:
	...
	lda l01bbh		;244a	3a bb 01 	: . . 
	ora a			;244d	b7 	. 
	cnz s0239h		;244e	c4 39 02 	. 9 . 
...
l249bh:
	push psw			;249b	f5 	. 
	lxi h,l2683h+1		;249c	21 84 26 	. . & 
	cpi ' '		;249f	fe 20 	.   
	jc l24b7h		;24a1	da b7 24 	. . $ 
l24a4h:
	inr m			;24a4	34 	4 
	lda l01b9h+1		;24a5	3a ba 01 	: . . 
	cmp m			;24a8	be 	. 
...
l250ch:
	...
	call s2306h		;2513	cd 06 23 	. . # 
	dcr c			;2516	0d 	. 
	ldax b			;2517	0a 	. 
	mvi a,03eh		;2518	3e 3e 	> > 
	nop			;251a	00 	. 
l251bh:
...
l259eh:
	push b			;259e	c5 	. 
	mov c,a			;259f	4f 	O 
	mvi a,TAB		;25a0	3e 09 	> . 
	call s23c7h		;25a2	cd c7 23 	. . # 
	pop b			;25a5	c1 	. 
	ret			;25a6	c9 	. 
l25a7h:
	xra c			;25a7	a9 	. 
...
l2678h:
	...
	nop			;267f	00 	. 
l2680h:
	jnz l2678h		;2680	c2 78 26 	. x & 
l2683h:
	mvi a,LF		;2683	3e 0a 	> . 
l2685h:
	call 02ac9h		;2685	cd c9 2a 	. . * 
	ret			;2688	c9 	. 
l2689h:
	lxi d,FCB		;2689	11 5c 00 	. \ . 
	mvi b,TAB		;268c	06 09 	. . 
l268eh:
	ldax d			;268e	1a 	. 
l268fh:
	cpi '?'		;268f	fe 3f 	. ? 
l2691h:
	jz l293dh		;2691	ca 3d 29 	. = ) 
	cpi '$'		;2694	fe 24 	. $ 
	jz l293dh		;2696	ca 3d 29 	. = ) 
l2699h:
	mov m,a			;2699	77 	w 
	inx h			;269a	23 	# 
l269bh:
...
l269ch:
	dcr b			;269c	05 	. 
l269dh:
	jnz l268eh		;269d	c2 8e 26 	. . & 
l26a0h:
	ret			;26a0	c9 	. 
l26a1h:
	lxi h,FCB		;26a1	21 5c 00 	. \ . 
l26a4h:
	mvi m,000h		;26a4	36 00 	6 . 
l26a6h:
	lxi d,03008h		;26a6	11 08 30 	. . 0 
	ldax d			;26a9	1a 	. 
l26aah:
	cpi TAB		;26aa	fe 09 	. . 
	jc l26b1h		;26ac	da b1 26 	. . & 
	mvi a,008h		;26af	3e 08 	> . 
l26b1h:
	mov b,a			;26b1	47 	G 
	mov c,a			;26b2	4f 	O 
l26b3h:
...
l26b4h:
	...
	mov m,a			;26b6	77 	w 
	dcr c			;26b7	0d 	. 
	jnz l26b3h		;26b8	c2 b3 26 	. . & 
	mvi a,008h		;26bb	3e 08 	> . 
	sub b			;26bd	90 	. 
	mov c,a			;26be	4f 	O 
	inr c			;26bf	0c 	. 
l26c0h:
	inx h			;26c0	23 	# 
	dcr c			;26c1	0d 	. 
	jz l26cah		;26c2	ca ca 26 	. . & 
	mvi m,' '		;26c5	36 20 	6   
	jmp l26c0h		;26c7	c3 c0 26 	. . & 
l26cah:
	mvi m,'L'		;26ca	36 4c 	6 L 
	inx h			;26cc	23 	# 
l26cdh:
	mvi m,'I'		;26cd	36 49 	6 I 
	inx h			;26cf	23 	# 
l26d0h:
	mvi m,'B'		;26d0	36 42 	6 B 
	inx h			;26d2	23 	# 
	xra a			;26d3	af 	. 
	mov m,a			;26d4	77 	w 
	sta 0007ch		;26d5	32 7c 00 	2 | . 
	call s2672h		;26d8	cd 72 26 	. r & 
	lxi d,FCB		;26db	11 5c 00 	. \ . 
	jmp l2775h		;26de	c3 75 27 	. u ' 
	mvi a,0ffh		;26e1	3e ff 	> . 
	sta 0305dh		;26e3	32 5d 30 	2 ] 0 
	lxi h,DBUFF		;26e6	21 80 00 	. . . 
	shld l25d0h		;26e9	22 d0 25 	" . % 
	lxi h,0305bh		;26ec	21 5b 30 	. [ 0 
	mov a,m			;26ef	7e 	~ 
	sta l25cfh		;26f0	32 cf 25 	2 . % 
l26f3h:
	xra a			;26f3	af 	. 
	mov m,a			;26f4	77 	w 
l26f5h:
	ret			;26f5	c9 	. 
l26f6h:
	call s2647h		;26f6	cd 47 26 	. G & 
	lxi h,02cd3h		;26f9	21 d3 2c 	. . , 
	call l2678h		;26fc	cd 78 26 	. x & 
	mvi a,038h		;26ff	3e 38 	> 8 
	sta l25b3h		;2701	32 b3 25 	2 . % 
	xra a			;2704	af 	. 
	sta l25b4h		;2705	32 b4 25 	2 . % 
	lxi h,00000h		;2708	21 00 00 	. . . 
	shld 03062h		;270b	22 62 30 	" b 0 
	lhld FBASE		;270e	2a 06 00 	* . . 
	shld 0304dh		;2711	22 4d 30 	" M 0 
	lxi h,03100h		;2714	21 00 31 	. . 1 
	shld l25f6h		;2717	22 f6 25 	" . % 
	lxi d,l0400h		;271a	11 00 04 	. . . 
l271dh:
	dad d			;271d	19 	. 
l271eh:
	shld l261bh		;271e	22 1b 26 	" . & 
	lxi d,00300h		;2721	11 00 03 	. . . 
l2724h:
	dad d			;2724	19 	. 
	shld l2640h		;2725	22 40 26 	" @ & 
l2728h:
	lxi d,00300h		;2728	11 00 03 	. . . 
l272bh:
	dad d			;272b	19 	. 
l272ch:
	inx h			;272c	23 	# 
l272dh:
	shld 0304bh		;272d	22 4b 30 	" K 0 
l2730h:
	shld 03054h		;2730	22 54 30 	" T 0 
l2733h:
	jmp l27eah		;2733	c3 ea 27 	. . ' 
s2736h:
	cpi ' '		;2736	fe 20 	.   
	rz			;2738	c8 	. 
l2739h:
...
l2775h:
	...
	pop d			;277d	d1 	. 
	rnz			;277e	c0 	. 
	lxi h,02ce8h		;277f	21 e8 2c 	. . , 
	call s274eh		;2782	cd 4e 27 	. N ' 
	jmp WBOOT		;2785	c3 00 00 	. . . 
	mvi c,CLOSEF		;2788	0e 10 	. . 
	push d			;278a	d5 	. 
	call BDOS		;278b	cd 05 00 	. . . 
	cpi 0ffh		;278e	fe ff 	. . 
	pop d			;2790	d1 	. 
	rnz			;2791	c0 	. 
	lxi h,02d6bh		;2792	21 6b 2d 	. k - 
	call l2678h		;2795	cd 78 26 	. x & 
	jmp WBOOT		;2798	c3 00 00 	. . . 
s279bh:
...
s27a0h:
	...
	pop d			;27a8	d1 	. 
	rnz			;27a9	c0 	. 
	lxi h,02cffh		;27aa	21 ff 2c 	. . , 
	call s274eh		;27ad	cd 4e 27 	. N ' 
	jmp WBOOT		;27b0	c3 00 00 	. . . 
s27b3h:
	lda l25cbh		;27b3	3a cb 25 	: . % 
	cpi 019h		;27b6	fe 19 	. . 
	rz			;27b8	c8 	. 
	cpi 017h		;27b9	fe 17 	. . 
	rz			;27bb	c8 	. 
	...
	ret			;27be	c9 	. 
	cpi TAB		;27bf	fe 09 	. . 
	jnz l27d2h		;27c1	c2 d2 27 	. . ' 
l27c4h:
	mvi a,' '		;27c4	3e 20 	>   
	call l27d2h		;27c6	cd d2 27 	. . ' 
	lda l25d2h		;27c9	3a d2 25 	: . % 
	ani 007h		;27cc	e6 07 	. . 
	jnz l27c4h		;27ce	c2 c4 27 	. . ' 
	ret			;27d1	c9 	. 
l27d2h:
	push psw			;27d2	f5 	. 
	mov e,a			;27d3	5f 	_ 
	mvi c,LISTOUT		;27d4	0e 05 	. . 
	call BDOS		;27d6	cd 05 00 	. . . 
	pop psw			;27d9	f1 	. 
	lxi h,l25d2h		;27da	21 d2 25 	. . % 
	cpi LF		;27dd	fe 0a 	. . 
...
l27eah:
	xra a			;27ea	af 	. 
	sta l25d2h		;27eb	32 d2 25 	2 . % 
	sta 0305dh		;27ee	32 5d 30 	2 ] 0 
	sta 03065h		;27f1	32 65 30 	2 e 0 
	sta 03064h		;27f4	32 64 30 	2 d 0 
	sta 03067h		;27f7	32 67 30 	2 g 0 
	sta l25b5h		;27fa	32 b5 25 	2 . % 
	lda FCB		;27fd	3a 5c 00 	: \ . 
	cpi ' '		;2800	fe 20 	.   
	jz l293dh		;2802	ca 3d 29 	. = ) 
	mvi c,CURDSK		;2805	0e 19 	. . 
	call BDOS		;2807	cd 05 00 	. . . 
	lxi h,l25c9h		;280a	21 c9 25 	. . % 
	mov m,a			;280d	77 	w 
	inx h			;280e	23 	# 
	mov m,a			;280f	77 	w 
	inx h			;2810	23 	# 
	...
	mov m,a			;2817	77 	w 
	inx h			;2818	23 	# 
	mvi a,001h		;2819	3e 01 	> . 
	sta 0305eh		;281b	32 5e 30 	2 ^ 0 
	sta 0305fh		;281e	32 5f 30 	2 _ 0 
	lda FCB2+FCBFN		;2821	3a 6d 00 	: m . 
	cpi '$'		;2824	fe 24 	. $ 
	jnz l28c8h		;2826	c2 c8 28 	. . ( 
	lxi h,00081h		;2829	21 81 00 	. . . 
l282ch:
	mov a,m			;282c	7e 	~ 
	inx h			;282d	23 	# 
	cpi '$'		;282e	fe 24 	. $ 
...
l2833h:
	mov a,m			;2833	7e 	~ 
	ora a			;2834	b7 	. 
	jz l28c8h		;2835	ca c8 28 	. . ( 
	inx h			;2838	23 	# 
	cpi ' '		;2839	fe 20 	.   
	jz l2833h		;283b	ca 33 28 	. 3 ( 
	lxi d,l25cah		;283e	11 ca 25 	. . % 
	cpi 'A'		;2841	fe 41 	. A 
	jz l28a9h		;2843	ca a9 28 	. . ( 
	inx d			;2846	13 	. 
	cpi 'P'		;2847	fe 50 	. P 
	jz l28a9h		;2849	ca a9 28 	. . ( 
	inx d			;284c	13 	. 
	cpi 'S'		;284d	fe 53 	. S 
	jz l28a9h		;284f	ca a9 28 	. . ( 
	inx d			;2852	13 	. 
	cpi 'H'		;2853	fe 48 	. H 
	jz l28a9h		;2855	ca a9 28 	. . ( 
	inx d			;2858	13 	. 
	cpi 'L'		;2859	fe 4c 	. L 
	jz l28a9h		;285b	ca a9 28 	. . ( 
	inx d			;285e	13 	. 
	...
	cpi '-'		;286f	fe 2d 	. - 
	jnz l28b6h		;2871	c2 b6 28 	. . ( 
l2874h:
	lxi d,0305eh		;2874	11 5e 30 	. ^ 0 
	mov a,m			;2877	7e 	~ 
	cpi 053h		;2878	fe 53 	. S 
	jz l28a3h		;287a	ca a3 28 	. . ( 
	inx d			;287d	13 	. 
	cpi 04dh		;287e	fe 4d 	. M 
	jz l28a3h		;2880	ca a3 28 	. . ( 
	lxi d,03065h		;2883	11 65 30 	. e 0 
	cpi 04ch		;2886	fe 4c 	. L 
	jz l28a3h		;2888	ca a3 28 	. . ( 
	lxi d,03064h		;288b	11 64 30 	. d 0 
	cpi 051h		;288e	fe 51 	. Q 
	jz l28a3h		;2890	ca a3 28 	. . ( 
	lxi d,03067h		;2893	11 67 30 	. g 0 
	cpi 052h		;2896	fe 52 	. R 
	jz l28a3h		;2898	ca a3 28 	. . ( 
	lxi d,l25b5h		;289b	11 b5 25 	. . % 
	cpi 031h		;289e	fe 31 	. 1 
	jnz l28b6h		;28a0	c2 b6 28 	. . ( 
l28a3h:
	mov a,b			;28a3	78 	x 
	stax d			;28a4	12 	. 
	inx h			;28a5	23 	# 
	jmp l2833h		;28a6	c3 33 28 	. 3 ( 
l28a9h:
	mov a,m			;28a9	7e 	~ 
	sui 041h		;28aa	d6 41 	. A 
	cpi EOF		;28ac	fe 1a 	. . 
	jnc l28b6h		;28ae	d2 b6 28 	. . ( 
	stax d			;28b1	12 	. 
	inx h			;28b2	23 	# 
	jmp l2833h		;28b3	c3 33 28 	. 3 ( 
l28b6h:
	inx h			;28b6	23 	# 
	mvi m,CR		;28b7	36 0d 	6 . 
	lxi h,02d29h		;28b9	21 29 2d 	. ) - 
	call l2678h		;28bc	cd 78 26 	. x & 
	lxi h,00081h		;28bf	21 81 00 	. . . 
	call l2678h		;28c2	cd 78 26 	. x & 
	jmp WBOOT		;28c5	c3 00 00 	. . . 
l28c8h:
	lxi h,l25d3h		;28c8	21 d3 25 	. . % 
	call l2689h		;28cb	cd 89 26 	. . & 
	lxi h,l25f8h		;28ce	21 f8 25 	. . % 
	push h			;28d1	e5 	. 
	call l2689h		;28d2	cd 89 26 	. . & 
	pop h			;28d5	e1 	. 
	call s27b3h		;28d6	cd b3 27 	. . ' 
	jz l28e9h		;28d9	ca e9 28 	. . ( 
	push h			;28dc	e5 	. 
	push h			;28dd	e5 	. 
	call s2660h		;28de	cd 60 26 	. ` & 
	pop d			;28e1	d1 	. 
	call s279bh		;28e2	cd 9b 27 	. . ' 
	pop d			;28e5	d1 	. 
	call s27a0h		;28e6	cd a0 27 	. . ' 
l28e9h:
	lda l25cdh		;28e9	3a cd 25 	: . % 
	cpi 019h		;28ec	fe 19 	. . 
	jz l2904h		;28ee	ca 04 29 	. . ) 
	lxi h,l261dh		;28f1	21 1d 26 	. . & 
	push h			;28f4	e5 	. 
	push h			;28f5	e5 	. 
	call l2689h		;28f6	cd 89 26 	. . & 
	call s266ch		;28f9	cd 6c 26 	. l & 
	pop d			;28fc	d1 	. 
	call s279bh		;28fd	cd 9b 27 	. . ' 
	pop d			;2900	d1 	. 
	call s27a0h		;2901	cd a0 27 	. . ' 
l2904h:
	ret			;2904	c9 	. 
	lxi h,l25b0h		;2905	21 b0 25 	. . % 
	...
	sta 03066h		;2913	32 66 30 	2 f 0 
	lxi h,00000h		;2916	21 00 00 	. . . 
	shld l2619h		;2919	22 19 26 	" . & 
	lda 0304fh		;291c	3a 4f 30 	: O 0 
	ora a			;291f	b7 	. 
	cnz 02af9h		;2920	c4 f9 2a 	. . * 
	lxi h,l0400h		;2923	21 00 04 	. . . 
	shld l25f4h		;2926	22 f4 25 	" . % 
	xra a			;2929	af 	. 
	sta l25dfh		;292a	32 df 25 	2 . % 
	sta l25f3h		;292d	32 f3 25 	2 . % 
	sta l25b8h		;2930	32 b8 25 	2 . % 
	call s265ah		;2933	cd 5a 26 	. Z & 
	lxi d,l25d3h		;2936	11 d3 25 	. . % 
	call l2775h		;2939	cd 75 27 	. u ' 
	ret			;293c	c9 	. 
l293dh:
	lxi h,02d12h		;293d	21 12 2d 	. . - 
	call l2678h		;2940	cd 78 26 	. x & 
	jmp WBOOT		;2943	c3 00 00 	. . . 
s2946h:
	mov a,d			;2946	7a 	z 
	cmp h			;2947	bc 	. 
	rnz			;2948	c0 	. 
	...
	push d			;294d	d5 	. 
	push h			;294e	e5 	. 
	lda 0305dh		;294f	3a 5d 30 	: ] 0 
	ora a			;2952	b7 	. 
	jz l29a2h		;2953	ca a2 29 	. . ) 
	lhld l25d0h		;2956	2a d0 25 	* . % 
	lxi d,DBUFF		;2959	11 80 00 	. . . 
	call s2946h		;295c	cd 46 29 	. F ) 
	jnz l2977h		;295f	c2 77 29 	. w ) 
	lxi h,00000h		;2962	21 00 00 	. . . 
	shld l25d0h		;2965	22 d0 25 	" . % 
	call s2672h		;2968	cd 72 26 	. r & 
	mvi c,READS		;296b	0e 14 	. . 
	lxi d,FCB		;296d	11 5c 00 	. \ . 
	call BDOS		;2970	cd 05 00 	. . . 
	ora a			;2973	b7 	. 
	jnz l2989h		;2974	c2 89 29 	. . ) 
l2977h:
	lhld l25d0h		;2977	2a d0 25 	* . % 
	inx h			;297a	23 	# 
	shld l25d0h		;297b	22 d0 25 	" . % 
	dcx h			;297e	2b 	+ 
	lxi d,DBUFF		;297f	11 80 00 	. . . 
	dad d			;2982	19 	. 
	mov a,m			;2983	7e 	~ 
	cpi EOF		;2984	fe 1a 	. . 
	jnz l29ffh		;2986	c2 ff 29 	. . ) 
l2989h:
	lda 02ea3h		;2989	3a a3 2e 	: . . 
	ora a			;298c	b7 	. 
	sta 0305dh		;298d	32 5d 30 	2 ] 0 
	jz l29a2h		;2990	ca a2 29 	. . ) 
	call s2672h		;2993	cd 72 26 	. r & 
	lxi d,FCB		;2996	11 5c 00 	. \ . 
	lxi h,02d7eh		;2999	21 7e 2d 	. ~ - 
	call s274eh		;299c	cd 4e 27 	. N ' 
	jmp WBOOT		;299f	c3 00 00 	. . . 
l29a2h:
	lhld l25f4h		;29a2	2a f4 25 	* . % 
	lxi d,l0400h		;29a5	11 00 04 	. . . 
	call s2946h		;29a8	cd 46 29 	. F ) 
	jnz l29f0h		;29ab	c2 f0 29 	. . ) 
	call s265ah		;29ae	cd 5a 26 	. Z & 
	lxi h,00000h		;29b1	21 00 00 	. . . 
	shld l25f4h		;29b4	22 f4 25 	" . % 
	mvi b,0e5h		;29b7	06 e5 	. . 
	mvi l,0ffh		;29b9	2e ff 	. . 
l29bbh:
	inr l			;29bb	2c 	, 
l29bch:
	sui 00ah		;29bc	d6 0a 	. . 
	jnc l29bbh		;29be	d2 bb 29 	. . ) 
	adi 00ah		;29c1	c6 0a 	. . 
	mov h,a			;29c3	67 	g 
	mov a,l			;29c4	7d 	} 
	ora a			;29c5	b7 	. 
	jz l29ceh		;29c6	ca ce 29 	. . ) 
	ori '0'		;29c9	f6 30 	. 0 
	call OUTCHAR		;29cb	cd ef 01 	. . . 
l29ceh:
	mov a,h			;29ce	7c 	| 
	ori '0'		;29cf	f6 30 	. 0 
	pop h			;29d1	e1 	. 
	jmp OUTCHAR		;29d2	c3 ef 01 	. . . 
l29d5h:
	jnz l29bch		;29d5	c2 bc 29 	. . ) 
	jmp l29edh		;29d8	c3 ed 29 	. . ) 
	cpi 003h		;29db	fe 03 	. . 
	jnc 02a05h		;29dd	d2 05 2a 	. . * 
	dcr b			;29e0	05 	. 
	jz l29edh		;29e1	ca ed 29 	. . ) 
	mvi c,080h		;29e4	0e 80 	. . 
l29e6h:
	mvi m,EOF		;29e6	36 1a 	6 . 
	inx h			;29e8	23 	# 
	dcr c			;29e9	0d 	. 
	jnz l29e6h		;29ea	c2 e6 29 	. . ) 
l29edh:
	call s2647h		;29ed	cd 47 26 	. G & 
l29f0h:
	lhld l25f6h		;29f0	2a f6 25 	* . % 
	xchg			;29f3	eb 	. 
	lhld l25f4h		;29f4	2a f4 25 	* . % 
	push h			;29f7	e5 	. 
	inx h			;29f8	23 	# 
	shld l25f4h		;29f9	22 f4 25 	" . % 
	pop h			;29fc	e1 	. 
	dad d			;29fd	19 	. 
	mov a,m			;29fe	7e 	~ 
l29ffh:
